<div class="content">
  <div class="content-wrapper">
    <div class="content-title">
      <span>Update Teacher Record</span>
    </div>    
          ...
          <div class="form-column">
            <div class="form-group">
              ...
              <select name="gender" value=2>
                <option value="">--</option>
                <option value="1" <?php echo !empty($teacher['Faculty']['gender']) && $teacher['Faculty']['gender'] == 1 ? 'selected' : '' ?>>Male</option>
                <option value="2" <?php echo !empty($teacher['Faculty']['gender']) && $teacher['Faculty']['gender'] == 2 ? 'selected' : '' ?>>Female</option>
              </select>
          ...
          <div class="form-column">
            <div class="form-group">
              ...
              <?php foreach($subjects as $key => $value): ?>
                <input type="checkbox" name="subject[]" value="<?php echo $key ?>" <?php echo isset($faculty_subject[$key]) ? 'checked' : '' ?>><label><?php echo $value; ?></label>
              <?php endforeach; ?>
                </div>
